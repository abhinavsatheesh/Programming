import sys,random,os,mysql.connector, time, prettytable, numpy as np, matplotlib.pylab as pylab, matplotlib.pyplot as plt
...
option, index = pick(["Login", "Signup", "Exit"], "Main Menu")
try:
    if index==0:
        cls()
        ...
        if ch=="1":
            ...
            while True:
                ...
                if ques=="1":
                    ...
                    while True:
                        while True:
                            evenodd = input("Toss (Just enter the option number)\n1. Even\n2. Odd")
                            if evenodd=="1" or evenodd=="2":
                                break
                        toss_you = int(input("Enter a number"))
                        toss_prg = random.choice([1,2,3,4,5,6])
                        sum = toss_you+toss_prg
                        cls()
                        print("You entered:", toss_you)
                        print("Program entered:", toss_prg)
                        print("Sum:", sum)
                        if sum%2==0 and evenodd=="1":
                            print("You won the toss!")
                            while True:
                                toss=input("Do you wish to:-\n1. Bat first\n2. Bowl first")
                                if toss=="1":
                                    first = "batting"
                                    cls()
                            ...
                            first = random.choice(["batting", "bowling"])
                            if first=="batting":
                                print("Program chose to bat")
                                print("You have to bowl")
                                first = "bowling"
                                bowling_function("first",0)
                                break
                            else:
                                print("Program chose to bowl")
