...
def HI():   
    ...
    def GOTo():
        webbrowser.open_new_tab("https://www.edelweiss.in/quotes/options/nifty~2021-06-24~14100~ce")
    ...
    Add_to_Portfolio_Button = Button(master, text="+ Add Shares to Portfolio").place(x=1010, y=600)
