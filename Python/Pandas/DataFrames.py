import pandas as pd
Sales = pd.DataFrame({2014:[1000.5,150.8,200.9,30000,40000], 2015:[12000,10000,22000,30000,45000], 2016:[20000,50000,70000,100000,125000], 2017:[50000,60000,70000,80000,90000]}, index=["Madhu","Kusum","Kinshuk","Ankit","Shruti"])
#Display row labels
##print(Sales.index)
